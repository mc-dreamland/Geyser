...
public class BedrockPacketHelper_v407 extends BedrockPacketHelper_v390 {
    ...
    protected void registerContainerSlotTypes() {
        ...
        this.containerSlotTypes.put(15, ContainerSlotType.NULL);
        this.containerSlotTypes.put(16, ContainerSlotType.RECIPE_CONSTRUCTION);
        this.containerSlotTypes.put(17, ContainerSlotType.RECIPE_NATURE);
        this.containerSlotTypes.put(18, ContainerSlotType.RECIPE_ITEMS);
        this.containerSlotTypes.put(19, ContainerSlotType.RECIPE_SEARCH);
        this.containerSlotTypes.put(20, ContainerSlotType.RECIPE_SEARCH_BAR);
        this.containerSlotTypes.put(21, ContainerSlotType.RECIPE_EQUIPMENT);
        ...
        this.containerSlotTypes.put(61, ContainerSlotType.RECIPE_BOOK);
    }
